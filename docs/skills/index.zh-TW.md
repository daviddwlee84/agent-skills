...
| [`nautilus-trader`](nautilus-trader.md) | 辨識 v1 Cython／v2 Rust-PyO3 世代、同步對應版本文件、事件驅動回測與實盤安全關卡 | [docs](nautilus-trader.md) |
...
| [`experiment-knowledge-harness`](experiment-knowledge-harness.md) | ML/Quant 的研究記憶 —— 可推翻 findings 的 LEDGER、依 payoff 分流的 ROADMAP、帶單軸消融契約的預先登記 REPORT、自動渲染的 Mermaid 地圖 | [docs](experiment-knowledge-harness.md) |
